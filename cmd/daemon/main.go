...
func (d *Daemon) emit(evt string, correlationID string, data interface{}) {
	d.outputMu.Lock()
...
func (d *Daemon) serverHandler(t *kamune.Transport) error {
	...
	d.emit(EvtSessionStarted, "", map[string]interface{}{
...
func (d *Daemon) handleDial(cmd Command) {
	...
	go func() {
		...
		d.emit(EvtSessionStarted, cmd.ID, map[string]interface{}{
			"session_id":  sessionID,
			"is_server":   false,
...
func (d *Daemon) receiveLoop(ctx context.Context, sessionID string, t *kamune.Transport) {
	for {
		...
		d.emit(EvtMessageReceived, "", map[string]interface{}{
			"session_id":  sessionID,
...
func (d *Daemon) handleSendMessage(cmd Command) {
	...
	d.emit(EvtMessageSent, cmd.ID, map[string]interface{}{
...
func (d *Daemon) handleListSessions(cmd Command) {
	...
	d.emit(EvtResponse, cmd.ID, map[string]interface{}{
		"sessions": sessions,
	})
}
