...
// HKDF-SHA512 is the KDF and ChaCha20Poly1305 is the AEAD (used only within the
// HPKE key schedule; actual transport encryption uses the exported keys with
// XChaCha20-Poly1305 via enigma).
var (
