...
type Peer struct {
	...
	LastSeen      *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=LastSeen,proto3" json:"LastSeen,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_box_proto_rawDesc = "" +
	...
	"\bSequence\x18\x03 \x01(\x04R\bSequence\"k\n" +
	"\tHandshake\x12\x18\n" +
	...
	"\tFirstSeen\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tFirstSeen\x126\n" +
	"\bLastSeen\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\bLastSeenB\x06Z\x04./pbb\x06proto3"
...
var file_box_proto_depIdxs = []int32{
	...
	5, // 1: box.Metadata.Timestamp:type_name -> google.protobuf.Timestamp
	5, // 2: box.Peer.FirstSeen:type_name -> google.protobuf.Timestamp
	5, // 3: box.Peer.LastSeen:type_name -> google.protobuf.Timestamp
